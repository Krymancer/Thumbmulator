...
int decode(uint16_t inst){
  ...
  if((inst&0xFE00)==0x1C00){
      ...
      rb=(inst>>6)&0x7;
      if(rb){
      if(DISS) fprintf(stderr,"add r%u,r%u,#0x%X\n",rd,rn,rb);
          ra=read_register(rn);
          rc=ra+rb;
  ...
  if((inst&0xF800)==0x3000){
      rb=(inst>>0)&0xFF;
      rd=(inst>>8)&0x7;
      if(DISS) fprintf(stderr,"add r%u,#0x%02X\n",rd,rb);
      ra=read_register(rd);
      rc=ra+rb;
      write_register(rd,rc);
      do_nflag(rc);
  ...
  if((inst&0xFE00)==0x1800){
      ...
      rn=(inst>>3)&0x7;
      rm=(inst>>6)&0x7;
      if(DISS) fprintf(stderr,"add r%u,r%u,r%u\n",rd,rn,rm);
      ra=read_register(rn);
      rb=read_register(rm);
      rc=ra+rb;
      write_register(rd,rc);
  ...
  if((inst&0xFFC0)==0x4000){
      rd=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
      if(DISS) fprintf(stderr,"and r%u,r%u\n",rd,rm);
      ra=read_register(rd);
      rb=read_register(rm);
      rc=ra&rb;
      write_register(rd,rc);
  ...
  if((inst&0xF800)==0x1000){
      ...
      rm=(inst>>3)&0x07;
      rb=(inst>>6)&0x1F;
      if(DISS) fprintf(stderr,"asr r%u,r%u,#0x%X\n",rd,rm,rb);
      rc=read_register(rm);
      if(rb==0){
          if(rc&0x80000000){
              do_cflag_bit(1);
  ...
  if((inst&0xFFC0)==0x4100){
      rd=(inst>>0)&0x07;
      rs=(inst>>3)&0x07;
      if(DISS) fprintf(stderr,"asr r%u,r%u\n",rd,rs);
      rc=read_register(rd);
      rb=read_register(rs);
      rb&=0xFF;
      if(rb==0){
  ...
  if((inst&0xFFC0)==0x4380){
      rd=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
      if(DISS) fprintf(stderr,"bic r%u,r%u\n",rd,rm);
      ra=read_register(rd);
      rb=read_register(rm);
      rc=ra&(~rb);
      write_register(rd,rc);
  ...
  if((inst&0xFFC0)==0x42C0){
      rn=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
  if(DISS) fprintf(stderr,"cmn r%u,r%u\n",rn,rm);
      ra=read_register(rn);
      rb=read_register(rm);
      rc=ra+rb;
      do_nflag(rc);
  ...
  if((inst&0xFFC0)==0x4280){
      rn=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
      if(DISS) fprintf(stderr,"cmp r%u,r%u\n",rn,rm);
      ra=read_register(rn);
      rb=read_register(rm);
      rc=ra-rb;
      //fprintf(stderr,"0x%08X 0x%08X\n",ra,rb);
  ...
  if((inst&0xFFC0)==0x4040){
      rd=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
      if(DISS) fprintf(stderr,"eor r%u,r%u\n",rd,rm);
      ra=read_register(rd);
      rb=read_register(rm);
      rc=ra^rb;
      write_register(rd,rc);
  ...
  if((inst&0xF800)==0x0000){
      ...
      rm=(inst>>3)&0x07;
      rb=(inst>>6)&0x1F;
      if(DISS) fprintf(stderr,"lsl r%u,r%u,#0x%X\n",rd,rm,rb);
      rc=read_register(rm);
      if(rb==0){
          //if immed_5 == 0
          //C unnaffected
  ...
  if((inst&0xFFC0)==0x4080){
      rd=(inst>>0)&0x07;
      rs=(inst>>3)&0x07;
      if(DISS) fprintf(stderr,"lsl r%u,r%u\n",rd,rs);
      rc=read_register(rd);
      rb=read_register(rs);
      rb&=0xFF;
      if(rb==0){
  ...
  if((inst&0xF800)==0x0800){
      ...
      rm=(inst>>3)&0x07;
      rb=(inst>>6)&0x1F;
  if(DISS) fprintf(stderr,"lsr r%u,r%u,#0x%X\n",rd,rm,rb);
      rc=read_register(rm);
      if(rb==0){
  ...
  if((inst&0xFFC0)==0x40C0){
      rd=(inst>>0)&0x07;
      rs=(inst>>3)&0x07;
      if(DISS) fprintf(stderr,"lsr r%u,r%u\n",rd,rs);
      rc=read_register(rd);
      rb=read_register(rs);
      rb&=0xFF;
      if(rb==0){
  ...
  if((inst&0xF800)==0x2000){
      rb=(inst>>0)&0xFF;
      rd=(inst>>8)&0x07;
      if(DISS) fprintf(stderr,"mov r%u,#0x%02X\n",rd,rb);
  ...
  if((inst&0xFFC0)==0x4340){
      rd=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
      if(DISS) fprintf(stderr,"mul r%u,r%u\n",rd,rm);
      ra=read_register(rd);
      rb=read_register(rm);
      rc=ra*rb;
      write_register(rd,rc);
  ...
  if((inst&0xFFC0)==0x43C0){
      rd=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
      if(DISS) fprintf(stderr,"mvn r%u,r%u\n",rd,rm);
      ra=read_register(rm);
      rc=(~ra);
      write_register(rd,rc);
      do_nflag(rc);
  ...
  if((inst&0xFFC0)==0x4240){
      rd=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
      if(DISS) fprintf(stderr,"neg r%u,r%u\n",rd,rm);
      ra=read_register(rm);
      rc=0-ra;
      write_register(rd,rc);
      do_nflag(rc);
  ...
  if((inst&0xFFC0)==0x4300){
      rd=(inst>>0)&0x7;
      rm=(inst>>3)&0x7;
  if(DISS) fprintf(stderr,"orr r%u,r%u\n",rd,rm);
      ra=read_register(rd);
      rb=read_register(rm);
      rc=ra|rb;
      write_register(rd,rc);
  ...
  if((inst&0xFE00)==0x1E00){
      ...
      rn=(inst>>3)&7;
      rb=(inst>>6)&7;
      if(DISS) fprintf(stderr,"sub r%u,r%u,#0x%X\n",rd,rn,rb);
      ra=read_register(rn);
      rc=ra-rb;
      write_register(rd,rc);
      do_nflag(rc);
  ...
  if((inst&0xF800)==0x3800){
      rb=(inst>>0)&0xFF;
      rd=(inst>>8)&0x07;
      if(DISS) fprintf(stderr,"sub r%u,#0x%02X\n",rd,rb);
      ra=read_register(rd);
      rc=ra-rb;
      write_register(rd,rc);
      do_nflag(rc);
  ...
  if((inst&0xFE00)==0x1A00){
      ...
      rn=(inst>>3)&0x7;
      rm=(inst>>6)&0x7;
      if(DISS) fprintf(stderr,"sub r%u,r%u,r%u\n",rd,rn,rm);
      ra=read_register(rn);
      rb=read_register(rm);
      rc=ra-rb;
      write_register(rd,rc);
...
void write32(uint32_t addr, uint32_t data){
  if(DBUG) fprintf(stderr,"write32(%x,%x)\n",addr,data);
  write16(addr,(data & 0xFFFF));
  write16(addr+2,(data & 0xFFFF0000)>>16);
}

void write16(uint32_t addr, uint16_t data){
  if(DBUG) fprintf(stderr,"write16(%x,%x)\n",addr,data);
  write8(addr,(data & 0x00FF));
  write8(addr+1,(data & 0xFF00) >> 8);
}

void write8(uint32_t addr, uint8_t data){
  if(DBUG) fprintf(stderr,"write8(%x,%x)\n",addr,data);
  mem[addr] = data;
}

uint32_t read32(uint32_t addr){
  if(DBUG) fprintf(stderr,"read32(%x)\n",addr);
  uint32_t data;
  data = (read16(addr+2) << 16 ) | read16(addr);
  if(DBUG) fprintf(stderr,"read32 returned data =  %x)\n",data);
  return data;
}

uint16_t read16(uint32_t addr){
  if(DBUG) fprintf(stderr,"read16(%x)\n",addr);
  uint32_t data;
...
uint8_t read8(uint32_t addr){
  if(DBUG) fprintf(stderr,"read8(%x)\n",addr);
  uint8_t data;
...
uint16_t readinst16(uint32_t addr){
  if(DBUG) fprintf(stderr,"readinst16(%x)\n",addr);
  uint32_t data;
  data = (readinst8(addr+1) << 8) | (readinst8(addr));
  if(DBUG) fprintf(stderr,"readinst16 returned data =  %x)\n",data);
  return data;
}

uint8_t readinst8(uint32_t addr){
  if(DBUG) fprintf(stderr,"readinst8(%x)\n",addr);
  uint8_t data;
  ...
  data = mem[addr];
  if(DBUG) fprintf(stderr,"readinst8 returned data =  %x)\n",data);
  return data;
}
...
void printRegs(){
  printf("#--------------- REGS --------------#\n");
  for(int i=0;i<8;i++){
    if(i < 10) printf("r%d  [0x%08x]\n",i,registers[i]);
    else printf("r%d [0x%08x]\n",i,registers[i]);
  }
  printf("sp  [0x%08x]\n",sp);
  printf("lr  [0x%08x]\n",registers[14]);
  printf("pc  [0x%08x]\n",pc);
...
void printFlags(){
  ...
  printf("CPSR: ");
  //printf("N [%x]\n",(cpsr & CPSR_N) ? 1:0);
  if((cpsr & CPSR_N) ? 1:0){ printf("N"); }else{ printf("n");}
  //printf("Z [%x]\n",(cpsr & CPSR_Z) ? 1:0);
  if((cpsr & CPSR_Z) ? 1:0){ printf("Z"); }else{ printf("z");}
  //printf("C [%x]\n",(cpsr & CPSR_C) ? 1:0);
  if((cpsr & CPSR_C) ? 1:0){ printf("C"); }else{ printf("c");}
  //printf("V [%x]\n",(cpsr & CPSR_V) ? 1:0);
  if((cpsr & CPSR_V) ? 1:0){ printf("V"); }else{ printf("v");}
  //printf("Q [%x]\n",(cpsr & CPSR_Q) ? 1:0);
  if((cpsr & CPSR_Q) ? 1:0){ printf("Q"); }else{ printf("q");}
  printf("jifT_");
  int mode = cpsr & 0x1FF;
  if(mode == 0x13){
    printf("SVC\n");
...
void printProgramMemory(){
  ...
  while(pointer < 0x80000100){
    ...
    if(read32(pointer)) printf("<0x%08x> [0x%08x]\n",pointer,read32(pointer));
    pointer += 4;
  }
}
